...
import { FadeInOnScroll } from "@/components/page-transition";
        ...
        <div className="flex-1 flex flex-col max-w-[1600px] mx-auto w-full px-4 sm:px-6 md:px-12 lg:px-20 py-8 md:py-12">
          ...
          <div className="flex-1 flex items-center">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 w-full">
              {timelessCombos.slice(0, 3).map((combo, i) => (
                <FadeInOnScroll key={combo.id} delay={0.1 + i * 0.1}>
                  <ComboCard combo={combo} from="home" />
                </FadeInOnScroll>
              ))}
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col max-w-[1600px] mx-auto w-full px-4 sm:px-6 md:px-12 lg:px-20 py-8 md:py-12">
          ...
          <div className="flex-1 flex items-center">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 w-full">
              {trendingCombos.slice(0, 4).map((combo, i) => (
                <FadeInOnScroll key={combo.id} delay={0.05 + i * 0.08}>
                  <ComboCard combo={combo} from="home" />
                </FadeInOnScroll>
              ))}
            </div>
